          ...
          <div className="w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]">
            ...
            <div className="w-full md:mt-0 mt-6">
              <p className={`${styles.paragraph} text-left max-w-[450px]`}>
                Discover our comprehensive collection of resources, articles, and insights about autonomous vehicles and robotics technology.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap sm:justify-start justify-center w-full relative z-[1]">
            {innovations.map((card) => (
              <div key={card.id} className="flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
                <img src={card.icon} alt="icon" className="w-[42.6px] h-[27.6px] object-contain" />

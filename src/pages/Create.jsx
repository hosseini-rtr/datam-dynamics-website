...
const processSteps = [
  ...
  },
  {
    ...
    content:
      "Rigorous testing ensures reliability and safety, followed by smooth deployment and ongoing support.",
  },
];
        ...
        <section className={layout.section}>
          <div className={layout.sectionInfo}>
            <h2 className={styles.heading2}>
              Create Your Autonomous <br className="sm:block hidden" /> Solution
            </h2>

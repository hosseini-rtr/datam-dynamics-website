          ...
          <div className={`${styles.boxWidth}`}>
            <div className="flex flex-col items-center justify-center py-20">
              ...
              <p className={`${styles.paragraph} text-center mt-5`}>
                ...
                contact you soon to discuss the opportunities.
              </p>
            </div>
          </div>
        </div>
          ...
          <section className={`flex flex-col ${styles.paddingY}`}>
            <div className={layout.sectionInfo}>
              ...
              <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
                Partner with us to drive innovation in autonomous technology and
            ...
            >
              <div className="flex flex-col gap-6">
                ...
                <FormInput
                  ...
                  //   },
                  //   { value: "strategic_sponsor", label: "Strategic Sponsor" },
                  // ]}
                />

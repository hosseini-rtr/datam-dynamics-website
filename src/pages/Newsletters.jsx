...
const newsletterCategories = [
  {
    ...
    description: "Stay informed about the latest developments in autonomous technology and robotics."
  },
  {
    id: "cat-2",
    title: "Industry Insights",
    description: "Receive expert analysis and insights about the autonomous systems industry."
  },
  {
    id: "cat-3",
    title: "Company News",
    description: "Get updates about our latest projects, partnerships, and company developments."
  }
];
...
const NewsletterCard = ({ title, description }) => (
  <div className="flex flex-col p-8 rounded-[20px] bg-black-gradient-2 hover:bg-black-gradient transition-all duration-300 shadow-xl h-full">
    <div className={`w-[60px] h-[60px] rounded-full ${styles.flexCenter} bg-blue-gradient mb-6`}>
      <img src={send} alt="send" className="w-[50%] h-[50%] object-contain filter brightness-110" />
    </div>
        ...
        <section className={layout.section}>
          <div className={layout.sectionInfo}>
            ...
            <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
              Get the latest updates and insights about autonomous technology delivered directly to your inbox.
            </p>
            <SubscriptionForm />
          </div>
